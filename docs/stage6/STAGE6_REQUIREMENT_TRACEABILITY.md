...
| FR-010/130 Case and tenant | shared domain + tenant-scoped repositories | Stage 1/2 tenant and domain tests | MyAIVAN current-candidate walkthrough | Core present; Stage 5B/5D not delivered |
