...
from aiven.llm.config import get_llm_provider_name
...
def _build_provider(name: str) -> LLMProvider:
    if name == "mock":
        ...
        from aiven.llm.providers.openai_provider import OpenAIProvider
        return OpenAIProvider()
    elif name in ("anthropic", "claude"):
        from aiven.llm.providers.anthropic_provider import AnthropicProvider
        return AnthropicProvider()
    elif name in ("google", "gemini"):
        from aiven.llm.providers.google_provider import GoogleProvider
        return GoogleProvider()
    elif name == "deepseek":
        from aiven.llm.providers.deepseek_provider import DeepSeekProvider
        return DeepSeekProvider()
    elif name == "qwen":
        from aiven.llm.providers.qwen_provider import QwenProvider
        return QwenProvider()
    else:
        from aiven.llm.providers.mock_provider import MockLLMProvider
        return MockLLMProvider()
