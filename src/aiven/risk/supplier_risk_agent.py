...
import os
from aiven.risk.models import SupplierRiskSearchPlan, SupplierRiskReport
from aiven.risk.web_search import get_web_search_provider
from aiven.risk.search_providers import get_search_provider_for_risk
from aiven.risk.evidence_extractor import extract_evidence_from_search_results
from aiven.risk.risk_scorer import score_supplier_risk
from aiven.utils.ids import new_risk_report_id
...
def generate_risk_search_plan(supplier_name: str, category: str = "") -> SupplierRiskSearchPlan:
    ...
    from aiven.llm.prompts import RISK_SEARCH_PLAN_SYSTEM
