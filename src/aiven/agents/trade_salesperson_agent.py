...
from aiven.openclaw.event_adapter import is_customer_message, is_supplier_reply
from aiven.openclaw.binding_store import get_project_id, bind_conversation
from aiven.openclaw.draft_store import create_draft_in_db
...
from aiven.agents.supplier_inquiry_agent import draft_supplier_inquiry
from aiven.agents.supplier_response_agent import parse_supplier_reply
...
from aiven.sourcing.supplier_registry import list_active as list_active_suppliers
...
from aiven.platforms.platform_registry import is_platform_trusted
from aiven.risk.supplier_risk_agent import run_risk_screening
from aiven.risk.risk_report import should_block_supplier
from aiven.leadtime.calculator import calculate_leadtime_for_requirement
from aiven.execution.event_log import append_event
from aiven.utils.ids import new_project_id
