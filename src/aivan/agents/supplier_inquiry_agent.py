...
from aivan.sourcing.marketplaces.marketplace_models import MarketplaceSupplierCandidate
from aivan.llm.gateway import llm_complete_json
from aivan.llm.prompts import SUPPLIER_INQUIRY_SYSTEM
