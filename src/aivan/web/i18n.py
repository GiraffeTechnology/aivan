...
CATALOG_EN: dict[str, str] = {
    ...
    "status.email_api_key_saved": "Email API Key saved in this browser.",
    "status.email_api_key_cleared": "Email API Key cleared from this browser.",
    ...
    "settings.email_key_missing": "Save the email sending API Key to enable Email.",
...
CATALOG_ZH: dict[str, str] = {
    ...
    "status.email_api_key_saved": "邮件 API Key 已保存在本浏览器。",
    "status.email_api_key_cleared": "邮件 API Key 已从本浏览器清除。",
    ...
    "settings.email_key_missing": "保存邮件发送 API Key 后才可启用邮件按钮。",
